...
<body>
                ...
                <table cellpadding="5px" cellspacing="5px"  align="center">
                    ...
                    <tr>
                        <th colspan="2" style="text-align: center;">
                            <input type="submit" value="Add" name="add1" style="background-color: chocolate;">
                        </th>
                    </tr>
                </table>
            </form>
        </div>
        <div class="col-md-4" style="display: block;border-right: solid;border-width: 1px;border-left: solid;border-width: 1px;">
            <form method="post" action="">
                <table cellpadding="5px" cellspacing="5px"  align="center">
                    <tr>
                    ...
                    <tr>
                        <th colspan="2" style="text-align: center;">
                            <input type="submit" value="Add" name="add2" style="background-color: chocolate;">
                        </th>
                    </tr>
                </table>
            </form>
        ...
        <div class="col-md-4" style="display: block;">
            <form method="post" action="">
                <table cellpadding="5px" cellspacing="5px"  align="center">
                    ...
                    <tr>
                        <th colspan="2" style="text-align: center;">
                            <input type="submit" value="Add" name="add3" style="background-color: chocolate;">
                        </th>
                    </tr>
                </table>
            </form>
    ...
    <div class="row">
        <div class="col-md-4" style="display: block;overflow-x: auto;">
            <table cellpadding="5px" cellspacing="5px"  align="center">
                <tr>
                    <th colspan="10"><h3 align="center">ArtWork Details</h3></th>
                </tr>
                <tr>
                    <th colspan="5">
                        <?php
        ...
        <div class="col-md-4" style="display: block;overflow-x: auto;border-right: solid;border-width: 1px;border-left: solid;border-width: 1px;">
            <table cellpadding="5px" cellspacing="5px"  align="center">
                <tr>
                    <th colspan="10"><h3 align="center">Artist Details</h3></th>
                </tr>
                <tr>
                    <th colspan="5">
                        <?php
        ...
        <div class="col-md-4" style="display: block;overflow-x: auto;">
            <table cellpadding="5px" cellspacing="5px"  align="center">
                <tr>
                    <th colspan="10"><h3 align="center">Customer Details</h3></th>
                </tr>
                <tr>
                    <th colspan="5">
                        <?php
